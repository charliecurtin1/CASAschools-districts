...
whp_ca <- rast(here("data", "wildfire", "intermediate", "whp_reclass.tif"))
```
...
schools_whp <- whp_schools %>% 
  select(CDSCode, CountyName, DistrictNa, DistrictTy, whp) %>% 
  st_drop_geometry()

#write_csv(schools_whp, here("data", "hazard_summary", "individual_tables", "schools_whp.csv"))
```
