...
```{r}
# create a vector of the districts that encountered an error based on the for loop output
districts_error <- c("08618200000000", "10767780000000", "19647250000000", "23655730000000", "27751500000000", "40687260000000", "40754650000000", "41688660000000", "41688900000000", "41690130000000", "41690390000000", "41690700000000", "49707630000000")

# filter for district that encountered an error
districts %>% filter(DistrictNa)
```
