...
# For loop with centroids

The process involves retrieving the maximum daily temperature values from 1961-1990 for each district centroid.
...
# generate 25 random points for school district and convert to be coordinates
...
So, we calculate our threshold to be 96 F. 35.72 C, or 96.29 F


Method 2: going back to using school districts
