...
# For loop with school districts

The process involves retrieving the maximum daily temperature values from 1961-1990 for each school district. Then we take the 98th percentile maximum daily temperature value for each school district across the range of time and average all of those to find the threshold for extreme heat.
