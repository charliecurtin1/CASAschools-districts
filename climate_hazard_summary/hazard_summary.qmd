...
districts_hazards <- districts_hazards_full %>% 
  select(CDSCode, CountyName, DistrictNa, DistrictTy, heat_days, heat_days_hist, heat_score, heat_score_hist, precip_days, precip_days_hist, precip_score, precip_score_hist, whp_score, whp_score_hist, slr_percent, slr_pct_hist, slr_score, slr_score_hist, flood_percent, flood_score, hazard_score, hazard_score_hist, EnrollTota, AApct, AIpct, ASpct, FIpct, HIpct, PIpct, WHpct, MRpct, NRpct, ELpct, FOSpct, HOMpct, MIGpct, SWDpct, geometry)

## write outputs to the data folder
# geopackage to preserve field names
st_write(districts_hazards, here("data", "hazard_summary", "hazard_summary", "districts_hazards_poly.gpkg"), append = FALSE)
...
write_csv(districts_hazards_csv, here("data", "hazard_summary", "districts_hazards.csv"))

test <- st_read(here("data", "hazard_summary", "districts_hazards.csv"))
```
