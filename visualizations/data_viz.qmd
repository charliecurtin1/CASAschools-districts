...
- histogram of extreme heat days historical
- bar chart of extreme heat score
- bar chart of extreme heat score historical
- bar chart of difference

```{r}
## histogram of projected extreme heat days -----------------------------------------------------
ggplot(districts_hazards) + 
  geom_histogram(aes(heat_days), fill = "orange", color = "black") +
  theme_minimal()

## histogram of historical extreme heat days ----------------------------------------------------
ggplot(districts_hazards) + 
  geom_histogram(aes(heat_days_hist), fill = "orange", color = "black") +
  theme_minimal()
...
## bar chart of extreme heat score -------------------------------------------------------------
ggplot(districts_hazards) + 
  geom_bar(aes(heat_score), fill = "orange", color = "black") +
  theme_minimal()

 ## bar chart of historical extreme heat score ---------------------------
ggplot(districts_hazards) + 
  geom_bar(aes(heat_score_hist), fill = "orange", color = "black") +
  theme_minimal()

## bar chart of difference ----------------------------------------------
ggplot(districts_hazards %>% 
         mutate(heat_diff = heat_score - heat_score_hist)) +
  geom_bar(aes(heat_diff), fill = "orange", color = "black") +
  theme_minimal()
```
...
ggplot(data = districts_hazards) +
  geom_sf(fill = NA, color = "black", lwd = .05) +
  geom_sf(data = flooding_simple, fill = "orange", lwd = NA) +
  theme_void()
```
