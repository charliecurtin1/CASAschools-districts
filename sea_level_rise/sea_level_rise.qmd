...
## recreating the process for 2000 sea levels

The 2000 sea levels represent the effects of a 100-year coastal storm without any sea level rise pulled from the CoSMoS model.
...
We are going to clip the sea level rise polygons to the boundary of California to exclude data that's in the ocean. Then we will simplify the polygons for mapping.
